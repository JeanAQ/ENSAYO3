...
const songs = [
  {
    name: "Envolver",
    author: "Anita",
    path: "./music/Anitta - Envolver.mp3",
  },
  {
    name: "Me Porto Bonito",
    author: "Bad Bunny ft Chencho Corleone",
    path: "./music/Bad Bunny ft. Chencho Corleone - meportobonito.mp3",
  },
  {
    name: "La Respuesta",
    author: "Becky G - Maluma",
    path: "./music/Becky G - Maluma - larespuesta.mp3",
  },
  {
    name: "Kai",
    author: "Skrillex & Diplo - Mind feat",
    path: "./music/Skrillex & Diplo - Kai.mp3",
  },
  {
    name: "Miénteme",
    author: "TINI - Maria Becerra",
    path: "./music/TINI - Maria Becerra - Miénteme.mp3",
  },
];
